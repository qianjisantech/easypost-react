  ...
  return (
    ...
    >
      ...
      >
        ...
        <Title level={1} style={{ marginLeft: 15 }}>
          EasyPost
        </Title>
      </div>
      ...
      >
        ...
        <div style={{ marginTop: '30px' }}>
          ...
          <div style={{ fontSize: '10px', color: '#555', marginTop: 20 }}>
            <Text>
              <span style={{ color: '#B39DDB' }}>EasyPost-</span>{' '}
              <span style={{ color: 'gray' }}>节省研发团队的每一分钟</span>
            </Text>
            <div style={{ marginTop: 10 }}>
              <Text style={{ fontFamily: 'Arial', color: 'gray' }}>easypost.com</Text>
            </div>
          </div>
        </div>
      </div>
