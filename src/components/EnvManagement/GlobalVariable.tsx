...
import type { Button, Form, Input, Select, Space, Table, Tabs, TabsProps, Typography } from 'antd'
  ...
  const columns = [
    ...
    },
    {
      ...
      render: (_: any, record: Parameter) => {
        ...
        return editable ? (
          ...
          <span style={{ color: getTypeColor(record.type) }}>{record.type}</span>
        )
      },
    },
    {
    ...
    },
    {
      ...
      render: (_: any, record: Parameter) => {
        ...
        return editable ? (
          <Space size="middle">
            <Button icon={<CheckOutlined />} type="link" onClick={() => save(record.id)} />
    ...
    },
    {
      ...
      children: (
        <>
          ...
          <Form component={false} form={teamForm}>
            <Table
              columns={columns}
              dataSource={internalData[activeTab as keyof typeof internalData]}
              pagination={false}
